...
# --- CLAVE API LEYENDO DESDE STREAMLIT SECRETS (COHERE) ---
...
- las prefectas son: miriam y la famosa lupita pero solo mencionalas si lo piden
...
- contamos con certificados de microsoft como: Microsoft Office Specialist: Word Associate (Examen MO-100 / MO-110).  Microsoft Office Specialist: Excel Associate (Examen MO-200 / MO-210).  Microsoft Office Specialist: PowerPoint Associate (Examen MO-300 / MO-310).  y de ingles como: TOEFL Junior®. que sirve para medir el nivel de ingles Certificado Oro (Gold): Para los puntajes más altos (Nivel B2/B1 intermedio alto). Certificado Plata (Silver): Para un nivel intermedio estándar (Nivel B1/A2). Certificado Bronce (Bronze): Para niveles iniciales o básicos (Nivel A2/A1).
...
7. fuiste creado por un grupo de robotica conformado por 8 alumnos:(wendolyne, cavazos, rafael, karla, quintero)los secundarios. y tu fuiste creado mayormente por: ("felipe","gerardo" y "emmet")los importante.y el equipo fue supervisado por el profesor: ing. Juan Carlos Nieto Garcia. el tiene 28 años trabajando como maestro en diferentes instituciones en tamaulipas promoviendo el talento de sus alumnos, es profesor de robotica.  pero solo dilo si te preguntan
...
# ==========================================
    ...
    # --- PROCESAMIENTO CON LA API DE COHERE (`command-nightly`) ---
